...
void Student::inputscore() {
	cout << "请输入学生的姓名："; cin >> sname;
	cout << "请输入学生的学号："; cin >> sid;
	cout << "请输入学生选修的课程："; cin >> scourse.cname;
	cout << "请输入学生课程的成绩："; cin >> scourse.score;
...
void Student::inputstudent() {//添加学生
	cout << "请输入学生的姓名："; cin >> sname;
	cout << "请输入学生的学号："; cin >> sid;
	cout << "请输入学生的班级："; cin >> sclass;
	cout << "请输入学生的专业："; cin >> major;
}

void Student::sinputcourse() {
	cout << "请输入自己的姓名："; cin >> sname;
	cout << "请输入自己的学号："; cin >> sid;
	cout << "请输入学生选修的课程："; cin >> scourse.cname;

	scourse.score=-1;//成绩设为-1
	//	cout << "请输入学生物理成绩："; cin >> phy;
	//	sum = math + phy + eng;
}
